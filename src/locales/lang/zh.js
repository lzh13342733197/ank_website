...
export default {
  ...
  home: {
    ...
    aboutUs: "关于我们",
    homeAboutUs:
      'Ankbit 是一家专注于音频设备制造的高新技术企业，在耳机、音箱及蓝牙收发器领域具备深厚的技术积累与生产经验。我们提供从产品定义、工业设计、软硬件研发到规模生产的 <strong>ODM、OEM 与深度定制化服务</strong>，拥有完整的供应链体系与自动化生产线。凭借严格的质量管控与敏捷的交付能力，我们致力于为全球客户提供高品质、可定制的一站式音频解决方案。',
