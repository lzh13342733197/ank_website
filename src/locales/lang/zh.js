...
export default {
  ...
  research: {
    ...
    teamDesc2: "依托公司雄厚的综合实力、自主创新能力及深入骨髓的品质理念，爱科贝已发展成为一家具备完整产业链、集研发、生产、销售于一体的高新技术企业。在董事会及管理委员会的战略指引下，我们正朝着属于全体员工的广阔未来扬帆远航。",
    teamDesc3:
  ...
  aboutUs: {
    ...
    awards:{
      description:'我们的产品设计不仅注重美学，更追求卓越的用户体验。凭借创新的设计理念，我们已成功斩获包括<strong>法国巴黎DNA设计奖、伦敦设计奖、美国Muse设计奖以及工业设计界“奥斯卡”之称的德国红点产品奖在内的多项国际大奖</strong>。这些荣誉是对我们设计团队专业能力与前瞻视野的最佳证明。'
    },
    DevelopmentCourse: {
      title: "公司发展历程",
      firstDate: "2025年1月",
