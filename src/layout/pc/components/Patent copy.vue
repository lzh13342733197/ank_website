<template>
  ...
  <div v-if="showPreview" class="preview-modal" @click="showPreview = false">
    <button class="carousel-btn prev-btn preview-btn" @click.stop="handlePreview(previewIndex - 1)">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" fill="none">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.75 19.5L8.25 12l7.5-7.5" />
      </svg>
    </button>
    ...
    <button class="carousel-btn next-btn preview-btn" @click.stop="handlePreview(previewIndex + 1)">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" fill="none">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
      </svg>
    </button>
