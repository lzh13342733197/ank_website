<template>
  <div :class="styles.navigationBarWrapper">
    <div :class="[styles.navigationBarItemList, { expanded: isSearchExpanded }]" :style="expandedStyle">
      ...
      <!-- <div class="navigation-bar-item" @click="$router.push('/company-profile')" style="cursor: pointer;">brand
        Introduction</div>
      <div class="navigation-bar-item" @click="$router.push('/Contact_us')" style="cursor: pointer;">contact us</div> -->
